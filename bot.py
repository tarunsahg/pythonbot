...
BOT_TOKEN = "5145890357:AAHfeExRL7hEDY-B5zf9ze1cvPlvYN6DlDQ"
PAYMENT_CHANNEL = "@Payment0124" #add payment channel here including the '@' sign
OWNER_ID = 1416317143 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@REAL_BOT_ONLY1"," @TECHNICALNOEL "] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
